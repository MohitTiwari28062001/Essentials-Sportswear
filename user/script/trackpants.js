...
let container = document.getElementById("tcksContainer");
...
async function sortme() {
    ...
    let data = await fetch(`http://localhost:3000/Trackpants?price${ option }=${ inpbox }`)
...
async function getData() {
    let data = await fetch("http://localhost:3000/Trackpants");

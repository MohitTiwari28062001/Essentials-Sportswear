...
let container = document.getElementById("ovsContainer");
...
async function sortme() {
    ...
    let data = await fetch(`http://localhost:3000/Oversized?price${ option }=${ inpbox }`)
...
async function getData() {
    let data = await fetch("http://localhost:3000/Oversized");

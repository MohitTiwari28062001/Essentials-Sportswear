...
let container = document.getElementById("cmpContainer");
...
async function sortme() {
    ...
    let data = await fetch(`http://localhost:3000/Compression?price${ option }=${ inpbox }`)
...
async function getData() {
    let data = await fetch("http://localhost:3000/Compression");

...
let container = document.getElementById("vesContainer");
...
async function sortme() {
    ...
    let data = await fetch(`http://localhost:3000/Vests?price${ option }=${ inpbox }`)
...
async function getData() {
    let data = await fetch("http://localhost:3000/Vests");
